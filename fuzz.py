...
def test_idempotent_any_syntatically_valid_python(
    src_contents: str, mode: grey.FileMode
) -> None:
    ...
    try:
        dst_contents = grey.format_str(src_contents, mode=mode)
    except grey.InvalidInput:
        # This is a bug - if it's valid Python code, as above, grey should be
    ...
    grey.assert_equivalent(src_contents, dst_contents)
    grey.assert_stable(src_contents, dst_contents, mode=mode)

    # Future test: check that pure-python and mypyc versions of grey
